...
int main(void) {
    ...
    while(1) {
		...
		if(lib_read_button_0()){
			current_led_val = current_led_val + 15;
		}
		//button1 = 24
		if(lib_read_button_1()){
			current_led_val = current_led_val + 24;
		}
		//button2 = 56
		if(lib_read_button_2()){
			current_led_val = current_led_val + 56;
		}
		//button3 = 111
		if(lib_read_button_3()){
			current_led_val = current_led_val + 111;
		}
		
		lib_write_leds(current_led_val);
		current_led_val = 0x00;
	}
